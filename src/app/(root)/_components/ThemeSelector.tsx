  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className="w-full sm:w-48 group relative flex items-center gap-2 px-3 py-2 bg-[#1e1e2e]/80 hover:bg-[#262637] rounded-lg transition-all duration-200 border border-gray-800/50 hover:border-gray-700 min-h-[44px]"
      >
        ...
        <span className="text-gray-300 text-sm sm:min-w-[80px] text-left group-hover:text-white transition-colors">
          {currentTheme?.label}
        </span>
        <div
        ...
        />
        <ChevronDownIcon
          className={`size-4 ml-auto text-gray-400 transition-all duration-300 group-hover:text-gray-300 ${isOpen ? "rotate-180" : ""}`}
        />
      </motion.button>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-full sm:min-w-[240px] bg-[#1e1e2e]/95 backdrop-blur-xl rounded-xl border border-[#313244] shadow-2xl py-2 z-50"
          >
            ...
            {THEMES.map((t, index) => (
              <motion.button
                ...
                className={`relative group w-full flex items-center gap-3 px-3 py-2 transition-all duration-200 ${
              ...
              >
                ...
                <span className="flex-1 text-left text-sm group-hover:text-white transition-colors">
                  {t.label}
                </span>
                <div
